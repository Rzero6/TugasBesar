...
public class CellStatus extends javax.swing.JPanel {
    ...
    public CellStatus(StatusType type, Color c) {
        initComponents();
        status.setType(type);
    ...
    private void initComponents() {
        ...
        status = new KasirDashboard.TableStatus();

        setBackground(new java.awt.Color(255, 255, 255));

        jPanel1.setBackground(new java.awt.Color(198, 231, 255));
    ...
    private KasirDashboard.TableStatus status;
